    ...
    window.onload = function (){
        var oimg1 = document.getElementById("win_img_1"),
            ...
            for(var i = 0;i < img1.length;i++){
              img1[i].style.background = "url('../../../public/home/image/color_"+ i +".jpg') no-repeat 50% 50%";
              img1[i].style.backgroundSize = "cover";
            }
            for(var i = 0;i < img2.length;i++){
              var num = i+8;
              img2[i].style.background = "url('../../../public/home/image/color_"+ num +".jpg') no-repeat 50% 50%";
              img2[i].style.backgroundSize = "cover";
            }
            for(var i = 0;i < img3.length;i++){
              var num = i+16;
              img3[i].style.background = "url('../../../public/home/image/color_"+ num +".jpg') no-repeat 50% 50%";
              img3[i].style.backgroundSize = "cover";
            }
            for(var i = 0;i < img4.length;i++){
              var num = i+24;
              img4[i].style.background = "url('../../../public/home/image/color_"+ num +".jpg') no-repeat 50% 50%";
              img4[i].style.backgroundSize = "cover";
            }
            for(var i = 0;i < teacher_img1.length;i++){
              var num = i+1;
              teacher_img1[i].style.background = "url('../../../public/home/image/teacher_"+ num +".jpg') no-repeat 50% 50%";
              teacher_img1[i].style.backgroundSize = "cover";
            }
            for(var i = 0;i < teacher_img2.length;i++){
              var num = i+9;
              teacher_img2[i].style.background = "url('../../../public/home/image/teacher_"+ num +".jpg') no-repeat 50% 50%";
              teacher_img2[i].style.backgroundSize = "cover";
            }
            for(var i = 0;i < teacher_img3.length;i++){
              var num = i+17;
              teacher_img3[i].style.background = "url('../../../public/home/image/teacher_"+ num +".jpg') no-repeat 50% 50%";
