...
<div class="body">
	<div class="write">
		...
		<form action="<?php echo (MANAGER); ?>write" method = "post">
			<input type="text" name="title" placeholder="标题"/><br>
			<input type="text" name="type" placeholder="分类标签"/><br>
			<textarea  name = "text" class="form-control" rows="29" placeholder="正文" style="width: 100%;"></textarea>
