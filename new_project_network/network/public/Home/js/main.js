    ...
    (function(){//开学倒计时
    	...
    	function timer(){
    		var now = new Date().getTime(),
    			...
    			dayH.children[0].src = '../../../public/home/image/num'+(day + "").slice(0,1)+".png";
    			dayH.children[1].src = '../../../public/home/image/num'+(day + "").slice(1,2)+".png";
    			houtH.children[0].src = '../../../public/home/image/num'+(hour + "").slice(0,1)+".png";
    			houtH.children[1].src = '../../../public/home/image/num'+(hour + "").slice(1,2)+".png";
    			branchH.children[0].src = '../../../public/home/image/num'+(branch + "").slice(0,1)+".png";
    			branchH.children[1].src = '../../../public/home/image/num'+(branch + "").slice(1,2)+".png";
    			secondsH.children[0].src = '../../../public/home/image/num'+(seconds + "").slice(0,1)+".png";
    			secondsH.children[1].src = '../../../public/home/image/num'+(seconds+ "").slice(1,2)+".png";        
    	}
    	timer();
