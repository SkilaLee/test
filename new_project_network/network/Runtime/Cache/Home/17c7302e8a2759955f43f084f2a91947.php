		...
		<div class="col-md-4 col-md-offset-4" style="  margin-top: 10%;">
			<div class="panel panel-default">
				...
				<div class="panel-body">
                    <form class="form-horizontal" id="yw0" action="<?php echo (MANAGER); ?>login" method="post">                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-3 col-md-4">
                            <div class="checkbox">
                                <label>
                                    <input id="ytLoginForm_remember" type="hidden" value="0" name="LoginForm[remember]" /><input name="remember" id="LoginForm_remember" value="1" type="checkbox" />记住我
                                </label>
                            </div>
                        </div>
