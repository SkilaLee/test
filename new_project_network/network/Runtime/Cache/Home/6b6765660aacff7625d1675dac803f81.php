...
<body>
    ...
    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="list-group" id="category">
	        <a href="<?php echo (MANAGER); ?>type?type=<?php echo ($vo["type"]); ?>" class="list-group-item">
		<span class="badge">6</span>
		<?php echo ($v["type"]); ?></a>    </div><?php endforeach; endif; else: echo "" ;endif; ?>
	<!-- 文章结束 -->
